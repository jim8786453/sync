...
"""POSTGRES_CONNECTION: if using the PostgresStorage backend as a base
...
E.g. postgresql://user:passlocalhost:5432/

"""
POSTGRES_CONNECTION = os.environ.get('POSTGRES_CONNECTION', None)
if POSTGRES_CONNECTION is None:
    POSTGRES_CONNECTION = 'postgresql://user:pass@localhost:5432/'
